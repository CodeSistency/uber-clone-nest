...
export class SafetyController {
  ...
  @ApiOperation({
    ...
    description:
      'Send an emergency alert during a ride that will notify authorities and emergency contacts',
  })
  @ApiBody({
    type: SOSAlertDto,
    description:
      'Emergency alert details including location and situation description',
  })
  @ApiResponse({
    status: 200,
    description:
      'SOS alert triggered successfully - emergency services and contacts notified',
    schema: {
      type: 'object',
      properties: {
  ...
  @ApiResponse({
    status: 429,
    description: 'Too many SOS alerts - rate limit exceeded',
  })
  @ApiResponse({
    status: 500,
    description: 'Database error or notification service failure',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all safety-related incidents and reports associated with a specific user',
  })
  @ApiParam({
    name: 'userId',
      ...
      items: {
        ...
        properties: {
          ...
          type: {
            type: 'string',
            example: 'sos_alert',
            enum: ['sos_alert', 'safety_check', 'incident_report'],
          },
          ...
          description: {
            type: 'string',
            example: 'Medical emergency during ride',
          },
  ...
  @ApiResponse({
    status: 403,
    description: 'Not authorized to view these safety reports',
  })
