...
export class AdminCreateStoreDto {
  ...
  @ApiProperty({
    ...
    enum: ['restaurant', 'grocery', 'pharmacy', 'convenience', 'other'],
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    example: 2.5,
    description: 'Delivery fee for orders from this store',
    required: false,
    default: 0,
  })
  @IsNumber()
  ...
  @ApiProperty({
    example: true,
    description: 'Whether the store is featured',
    required: false,
    default: false,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    example: 'Chase Bank',
    description: 'Name of the bank for payouts',
    required: false,
  })
  @IsString()
  @IsOptional()
