...
export class CreateErrandDto {
  @ApiProperty({
    ...
    example: 'Comprar leche, pan integral, frutas frescas y medicamentos en la farmacia',
    minLength: 10,
    maxLength: 300,
    type: 'string'
  })
  ...
  @ApiProperty({
    description: 'Dirección donde el conductor debe recoger al cliente para iniciar el mandado',
  ...
  @ApiProperty({
    description: 'Dirección donde el conductor debe dejar al cliente después de completar el mandado',
...
export class ErrandShoppingUpdateDto {
  ...
  @ApiPropertyOptional({
    description: 'Notas adicionales sobre las compras realizadas o cualquier incidente',
    example: 'La leche estaba agotada así que compré una alternativa. El medicamento estaba disponible en la farmacia del segundo piso.',
    maxLength: 300,
    type: 'string'
  })
  @IsOptional()
