...
-- CreateIndex
CREATE INDEX "wallet_transactions_wallet_id_created_at_idx" ON "public"."wallet_transactions"("wallet_id", "created_at");
...
-- CreateIndex
CREATE INDEX "wallet_audit_logs_admin_id_timestamp_idx" ON "public"."wallet_audit_logs"("admin_id", "timestamp");
...
-- CreateIndex
CREATE INDEX "wallet_audit_logs_timestamp_idx" ON "public"."wallet_audit_logs"("timestamp");

-- CreateIndex
CREATE INDEX "wallet_audit_logs_ip_address_idx" ON "public"."wallet_audit_logs"("ip_address");

-- CreateIndex
CREATE INDEX "wallet_rate_limits_user_id_operation_attempted_at_idx" ON "public"."wallet_rate_limits"("user_id", "operation", "attempted_at");
...
-- AddForeignKey
ALTER TABLE "public"."wallet_audit_logs" ADD CONSTRAINT "wallet_audit_logs_admin_id_fkey" FOREIGN KEY ("admin_id") REFERENCES "public"."users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
